...
namespace UseItemSheet
{
    ...
    { 
        ...
        static string spreadSheetID = "1fPvVVO0mvLiZ-eg4oYgDP2jXrL6u03GYq0kBRBwE-Xs"; // it is file id
...
/*Load Data From Google Sheet! Working fine with runtime&editor*/
        ...
        {      
            ...
            FieldInfo[] fields = typeof(UseItemSheet.Data).GetFields(BindingFlags.Public | BindingFlags.Instance);
              ...
              if (json != null)
                        {
                            ...
                            if (typeValuesCList.Count != 0)
                            {
                                ...
                                {
                                    UseItemSheet.Data instance = new UseItemSheet.Data();
...
/*Load From Cached Json. Require Generate Data.*/
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            List<List<string>> typeValuesCList = new List<List<string>>(); 
            //Load GameData.
            string text = reader.ReadData("UseItemSheet");
            if (text != null)
            {
