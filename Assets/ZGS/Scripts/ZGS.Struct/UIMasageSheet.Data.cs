...
namespace UIMasageSheet
{
    ...
    { 
        ...
        static string spreadSheetID = "1ZJAPGBo9lW2ieY7crilL0rA8gZ5Z5Uf4dNUaiEwMea8"; // it is file id
...
/*Load Data From Google Sheet! Working fine with runtime&editor*/
        ...
        {      
            ...
            FieldInfo[] fields = typeof(UIMasageSheet.Data).GetFields(BindingFlags.Public | BindingFlags.Instance);
              ...
              if (json != null)
                        {
                            ...
                            if (typeValuesCList.Count != 0)
                            {
                                ...
                                {
                                    UIMasageSheet.Data instance = new UIMasageSheet.Data();
...
/*Load From Cached Json. Require Generate Data.*/
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            List<List<string>> typeValuesCList = new List<List<string>>(); 
            //Load GameData.
            string text = reader.ReadData("UIMasageSheet");
            if (text != null)
            {
