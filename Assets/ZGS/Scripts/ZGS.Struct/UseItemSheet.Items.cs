...
/*Write To GoogleSheet!*/
        ...
        public static void Write(Items data, System.Action onWriteCallback = null)
        { 
            TypeMap.Init();
...
/*Load Data From Google Sheet! Working fine with runtime&editor*/
        ...
        {      
            ...
            List<Items> callbackParamList = new List<Items>();
            Dictionary<int,Items> callbackParamMap = new Dictionary<int, Items>();
            webInstance.ReadGoogleSpreadSheet(spreadSheetID, (data, json) => {
            FieldInfo[] fields = typeof(UseItemSheet.Items).GetFields(BindingFlags.Public | BindingFlags.Instance);
              ...
              if (json != null)
                        {
                            ...
                            if (typeValuesCList.Count != 0)
                            {
                                ...
                                {
                                    UseItemSheet.Items instance = new UseItemSheet.Items();
                                    ...
                                    if(updateCurrentData)
                                    {
                                       ...
                                       ItemsMap.Add(instance.index, instance);
                                    }
                                } 
                            }
                        }
